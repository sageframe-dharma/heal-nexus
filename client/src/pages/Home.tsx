  ...
  return (
    <div className="h-screen relative selection:bg-primary/10 flex flex-col overflow-hidden" style={{ background: '#040e1c' }}>
      ...
      <div className="relative z-30 w-full flex flex-col items-center pt-3 md:pt-4 pb-3 shrink-0">
        <header className="text-center space-y-2 md:space-y-3 px-6 py-3 md:px-8 md:py-5 rounded-xl w-fit" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
        ...
        <nav className="flex items-center gap-6 md:gap-8 px-5 py-2 mt-1.5 rounded-lg w-fit" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
            ...
            <AnimatePresence mode="wait">
              ...
              {activeView === 'about' && (
                <motion.div
                  ...
                  transition={{ duration: 0.45, ease: [0.25, 0.46, 0.45, 0.94] }}
                >
                  <div className="px-5 py-6 rounded-2xl" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
              ...
              {activeView === 'book' && (
                <motion.div
                  ...
                  transition={{ duration: 0.45, ease: [0.25, 0.46, 0.45, 0.94] }}
                >
                  <div className="text-center px-5 py-6 rounded-2xl" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
        ...
        <div className="flex md:hidden flex-col items-center h-full pt-6">
          <AnimatePresence mode="wait">
            ...
            {activeView === 'about' && (
              ...
              >
                <div className="rounded-2xl px-5 py-6" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
            ...
            {activeView === 'book' && (
              <motion.div
                ...
                className="w-full px-2"
              >
                <div className="text-center rounded-2xl px-5 py-6" style={{ background: 'rgba(200, 238, 252, 0.62)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
      ...
      <AnimatePresence>
        {activeView === 'services' && activeService && (
          <motion.div
            ...
            style={{ background: 'rgba(200, 238, 252, 0.70)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', maxHeight: '45svh' }}
          >
