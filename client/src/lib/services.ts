...
export const SERVICES: ServiceInfo[] = [
  ...
  {
    name: "Craniosacral\nTherapy For\nBabies",
    label: "Craniosacral Therapy For Babies",
    image: doulaImage,
    hexImage: birthImage,
    imageScale: 1.3,
    imagePosition: "center 28%",
    description:
      "I spent many years as a doula supporting families through pregnancy, labor, and birth. Now I bring Craniosacral Therapy to that same work—with pregnant people throughout pregnancy and with babies after birth. I offer home visits during the fourth trimester, and continue that care in my treatment space in Cambridge.",
    experienceText:
